...
public class Multi extends LogicElement {
    public Multi() {
        super("multi", new Parameter[]{
                new Parameter(null, new Datatype[]{ new Float(), new Integer() }, "multiplication num 1"),
                new Parameter(null, new Datatype[]{ new Float(), new Integer() }, "multiplication num 2")
        });
    }
