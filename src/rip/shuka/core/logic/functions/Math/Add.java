...
public class Add extends LogicElement {
    public Add() {
        super("add", new Parameter[]{
                new Parameter(null, new Datatype[]{ new Float(), new Integer() }, "addition num 1"),
                new Parameter(null, new Datatype[]{ new Float(), new Integer() }, "addition num 2")
        });
    }
